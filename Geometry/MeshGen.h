...
// ============================================================
MeshData CreateSphere(float radius = 1.0f,
                      int   stacks = 24,
                      int   slices = 48);
...
// ============================================================
MeshData CreateCone(float radius    = 1.0f,
                    float height    = 2.0f,
                    int   slices    = 36,
                    bool  capCenter = true);
...
// ============================================================
MeshData CreateCylinder(float radiusTop    = 1.0f,
...
//     height
// ============================================================
MeshData CreatePyramid(float baseSize = 1.0f,
                       float height   = 2.0f);
...
// ============================================================
MeshData CreateCuboid(float width  = 2.0f,
                      float height = 1.0f,
                      float depth  = 1.0f);
...
// ============================================================
MeshData CreateTriangularPrism(float baseSize = 1.0f,
                               float height   = 2.0f);
...
//     capTop / capBottom
// ============================================================
MeshData CreateHexagonalPrism(float radius    = 1.0f,
                              float height    = 2.0f,
                              bool  capTop    = true,
                              bool  capBottom = true);
...
//     stacks / slices
// ============================================================
MeshData CreateEllipsoid(float radiusX = 1.5f,
                         float radiusY = 1.0f,
                         float radiusZ = 0.75f,
                         int   stacks  = 24,
                         int   slices  = 48);
...
// ============================================================
MeshData CreateTorus(float majorRadius = 1.0f,
...
// ============================================================
MeshData CreateCapsule(float radius    = 0.5f,
                       float height    = 2.0f,
                       int   slices    = 32,
                       int   capStacks = 8);
...
// ============================================================
MeshData CreateIcosahedron(float radius       = 1.0f,
                           int   subdivisions = 0);
...
// ============================================================
MeshData CreateSpring(float coilRadius = 1.0f,
...
// ============================================================
MeshData CreateArch(float innerRadius = 0.6f,
                    float outerRadius = 1.0f,
                    float depth       = 0.4f,
                    float arcAngle    = 3.14159265f,
                    int   slices      = 32);
