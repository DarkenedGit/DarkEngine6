...
namespace Geometry
{
    ...
    MeshData CreateDodecahedron(float radius)
    {
        ...
        // 20 vertices
        const Vector3f V[20] = {
            { a, a, a }, { a, a, -a }, { a, -a, a }, { a, -a, -a }, { -a, a, a }, { -a, a, -a }, { -a, -a, a }, { -a, -a, -a }, { 0.f, c_, b_ }, { 0.f, c_, -b_ }, { 0.f, -c_, b_ }, { 0.f, -c_, -b_ }, { b_, 0.f, c_ }, { -b_, 0.f, c_ }, { b_, 0.f, -c_ }, { -b_, 0.f, -c_ }, { c_, b_, 0.f }, { c_, -b_, 0.f }, { -c_, b_, 0.f }, { -c_, -b_, 0.f }
        };
    ...
    MeshData CreateIcosahedron(float radius, int subdivisions)
    {
        ...
        const Vector3f icoV[12] = {
            { -s, t * s, 0 }, { s, t * s, 0 }, { -s, -t * s, 0 }, { s, -t * s, 0 }, { 0, -s, t * s }, { 0, s, t * s }, { 0, -s, -t * s }, { 0, s, -t * s }, { t * s, 0, -s }, { t * s, 0, s }, { -t * s, 0, -s }, { -t * s, 0, s }
        };
