...
namespace Dark::Math
{
	Ray2f::Ray2f(): Origin(Vector2f::ZERO), Direction(Vector2f::X_AXIS)
	{
	}

	Ray2f::Ray2f(const Vector2f& origin, const Vector2f& direction): Origin(origin), Direction(direction)
	{
	}
