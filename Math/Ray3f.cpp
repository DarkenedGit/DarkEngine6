...
namespace Dark::Math
{
	Ray3f::Ray3f(): Origin(Vector3f::ZERO), Direction(Vector3f::Z_AXIS)
	{
	}

	Ray3f::Ray3f(const Vector3f& origin, const Vector3f& direction): Origin(origin), Direction(direction)
	{
	}
