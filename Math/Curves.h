...
namespace Dark
{
	namespace Math
	{
		...
		inline Vector2f BezierCubic(const Vector2f& p0, const Vector2f& p1, const Vector2f& p2, const Vector2f& p3, float t)
		{
			float u   = 1.0f - t;
			float uu  = u * u;
			float uuu = uu * u;
		...
		inline Vector2f Hermite(const Vector2f& p0, const Vector2f& m0, const Vector2f& p1, const Vector2f& m1, float t)
		{
			float t2 = t * t;
			float t3 = t2 * t;
		...
		inline Vector2f CatmullRom(const Vector2f& p0, const Vector2f& p1, const Vector2f& p2, const Vector2f& p3, float t, float tautness = 0.5f)
		{
		...
		inline Vector3f BezierCubic(const Vector3f& p0, const Vector3f& p1, const Vector3f& p2, const Vector3f& p3, float t)
		{
			float u   = 1.0f - t;
			float uu  = u * u;
			float uuu = uu * u;
		...
		inline Vector3f BezierQuadraticDerivative(const Vector3f& p0, const Vector3f& p1, const Vector3f& p2, float t)
		{
		...
		inline Vector3f BezierCubicDerivative(const Vector3f& p0, const Vector3f& p1, const Vector3f& p2, const Vector3f& p3, float t)
		{
		...
		inline Vector3f Hermite(const Vector3f& p0, const Vector3f& m0, const Vector3f& p1, const Vector3f& m1, float t)
		{
			float t2 = t * t;
			float t3 = t2 * t;
			float h00 =  2.0f * t3 - 3.0f * t2 + 1.0f;
		...
		inline Vector3f CatmullRom(const Vector3f& p0, const Vector3f& p1, const Vector3f& p2, const Vector3f& p3, float t, float tautness = 0.5f)
		{
		...
		float BezierCubicLength(const Vector3f& p0, const Vector3f& p1, const Vector3f& p2, const Vector3f& p3, unsigned int segments = 16);
	}
}
