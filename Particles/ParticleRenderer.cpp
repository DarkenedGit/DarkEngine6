...
{
    m_renderer = &renderer;
    if (!m_pipeAdditive.create(renderer.device(), true)
        || !m_pipeAlpha.create(renderer.device(), false))
    {
...
void ParticleRenderer::draw(ID3D12GraphicsCommandList* cmd,
