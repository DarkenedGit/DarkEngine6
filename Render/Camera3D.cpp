...
namespace Dark
{
    ...
    Camera3D::Camera3D() :
        ...
        m_Right(Vector3f::X_AXIS),
        m_Up(Vector3f::Y_AXIS),
        m_Look(Vector3f::Z_AXIS),
        m_NearZ(0.1f),
        m_FarZ(1000.0f),
        m_Aspect(1.0f),
        m_FovY(Pi * 0.25f),
    ...
    void Camera3D::UpdateViewMatrix() const
    {
        ...
        m_View = Matrix4f(m_Right.x, m_Up.x, m_Look.x, 0.0f, m_Right.y, m_Up.y, m_Look.y, 0.0f, m_Right.z, m_Up.z, m_Look.z, 0.0f, x, y, z, 1.0f);
