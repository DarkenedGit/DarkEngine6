...
namespace Dark::AI
{
    ...
    bool HsmMachine::addSharedTransition(const std::vector<HsmState*>& sources, HsmEventId eventId, HsmState* target, HsmGuard guard, HsmAction action, HsmTransitionKind kind)
    {
        if (sources.empty())
        {
